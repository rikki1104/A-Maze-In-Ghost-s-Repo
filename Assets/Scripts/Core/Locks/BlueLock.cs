...
namespace Maze_Game.Core
{
        public class BlueLock : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
               isOpen = SaveManager.instance.activeSave.blueDoorOpen;
            }
        ...
        void OnTriggerStay(Collider other)
        {
            if(other.tag == "Player")
            {
                if(CrossPlatformInputManager.GetButton("Fire1") || Input.GetKeyDown(KeyCode.E) && SaveManager.instance.activeSave._blueKeyData)
                {
        ...
        {
            if(other.tag == "Player" && SaveManager.instance.activeSave._blueKeyData)
            {
            ...
            IEnumerator OpenBlueLockAnim()
            {
                ...
                isOpen = !isOpen;
                    ...
                    {                       
                        ...
                        this.gameObject.SetActive(!isOpen);
                        SaveManager.instance.activeSave.blueDoorOpen = isOpen;
                    }                            
            }
        }
    }
